...
def set_environment(rotation, simmetry_breaking, approach):
    ...
    if rotation:
        ...
        output_txt_path = f'./{approach}/outRot/txt' + subfolder
        output_img_path = f'./{approach}/outRot/img' + subfolder
        output_failure_path = f'./{approach}/outRot/failures.txt'
        ...
        if simmetry_breaking:
            ...
            subfolder = '/no_simmetry_breaking/'
        output_txt_path = f'./{approach}/out/txt' + subfolder
        output_img_path = f'./{approach}/out/img' + subfolder
        output_failure_path = f'./{approach}/out/failures.txt'
